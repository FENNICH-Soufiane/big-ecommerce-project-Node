...
exports.createUserValidator = [
  ...
  // for one phone
  // check('phone').isMobilePhone('ar-MA'),
  // for multi phone
  check('phone')
    .optional()
    .isMobilePhone(['ar-AE', 'ar-MA'])
    .withMessage('Invalid form number only accept pohone of Morocoo an UAE'),
...
exports.updateLoggedUserValidator = [
  ...
  check('phone')
    .optional()
    // .isMobilePhone(['ar-EG', 'ar-SA', 'ar-MA'])
    .isMobilePhone('ar-MA')
    .withMessage('Invalid phone number only accepted Egy and SA Phone numbers'),
